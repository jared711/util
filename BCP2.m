function [rvdot] = BCP2(t, rv, mu, mu3, a3, theta0)
%BCP2 Bicircular Problem set in the rotating frame of the larger bodies
%(e.g. Sun-Earth barycenter, with Moon in motion)
% 
% [rvdot] = BCP2(t, rv, mu, mu3, a3, theta0)
% 
...
% 
% See also: BCP1 CCP CR3BP PCR3BP
...
xdot = rv(4);   ydot = rv(5);
x3  = 1 - mu + a3*cos(theta); % x component for TER
