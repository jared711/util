...
%plot_prim(col, fig_num, origin, inert)
...
if isfield(PRIM,'color');       col = PRIM.color;            end

if isfield(PRIM,'img')
    pltplanet(PRIM.radius/RUNIT,[-mu;0;0] + offset, PRIM.img, fig_num)
else
...
%July 24, 2020      Jared T. Blanchard      Added pltplanet option