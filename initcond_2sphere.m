function [rvs, N] = initcond_2sphere(rv0, alpha, N, mu)
...
%secondary body, and they must have a velocity parallel to the 
%landing/periapsis velocity.
% 
% [rvs, N] = INITCOND_2SPHERE(rv0, r_radius, R2, N, mu)
% 
% Inputs: 
