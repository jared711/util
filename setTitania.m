% setTitania
% 
% model for Uranus-Titania CR3BP system
% 
% Record of Revision
% Date          Programmer          Description of Changes
% 01/23/2020    Jared T. Blanchard  Based off of Brian D. Anderson's
%                                   seteuropaglobal code
global mu URANUS TITANIA SUN PRIM SEC AU RUNIT TUNIT VUNIT AUNIT

disp('Set URANUS-TITANIA System');
SUN.name        = 'SUN';
...
SEC.name        = 'TITANIA';
SEC.gm          = 226.9;                     % km^3/s^2  (+-4.1)   http://ssd.jpl.nasa.gov/?sat_phys_par
SEC.radius      = 788.9;                        % km        (+-1.8  )   http://ssd.jpl.nasa.gov/?sat_phys_par
SEC.sm          = 436300;                       % km        (+-?    )   http://ssd.jpl.nasa.gov/?sat_elem
SEC.ecc         = 0.001;                       % unitless  (+-?    )   http://ssd.jpl.nasa.gov/?sat_elem
SEC.period      = 8.706444 * 86400;                % sec       (+-?    )   http://ssd.jpl.nasa.gov/?sat_elem
SEC.rot         = 2 * pi / SEC.period;          % rad/s synchronous     JUP310
SEC.color       = [0.5,0.5,0.5];
