function setearthmoonsun(ln)
% setearthmoonsun(ln)
% 
% model for Earth-Moon-Sun BCP system
% 
...
disp('Set Earth-Moon-Sun BCP System');
SUN.name        = 'SUN';
...
SEC = MOON;
TER = SUN;
TER.a = EARTH.sm/MOON.sm;
TER.mu = SUN.gm/(EARTH.gm+MOON.gm);
TER.orbit_bary = 1; % if true, then the tertiary body orbits the barycenter of the primary and secondary
